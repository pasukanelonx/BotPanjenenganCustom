...
const DB_STICKER = [
  "lah sticker lagi", 
  "apaan dah stickernya", 
  "sticker apaan bjir", 
  "ngapain kirim sticker", 
  "lu ngomong pake sticker sekarang?", 
  "sticker mulu lu", 
  "bjir sticker lagi", 
  "njir apaan tuh", 
  "sticker lu random bgt", 
  "ini maksudnya apa cok",
   "gua harus ketawa?", 
  "reaksi apaan itu", 
  "sticker doang wkwk", 
  "lu gabut banget", 
  "hobi lu sticker ya",
   "admin sticker datang",
    "si paling sticker",
     "sticker lagi sticker lagi",
      "satu sticker cukup lah",
       "jangan spam sticker", 
       "sticker lu banyak amat", 
       "stok sticker lu ga abis?", 
       "lu punya berapa sticker", 
       "koleksi sticker lu serem", 
       "galeri sticker berjalan", 
       "museum sticker dibuka", 
       "pamer koleksi ya", 
       "sticker apaan itu woi", 
       "ngakak liat stickernya", 
       "gajelas bgt sticker lu", 
       "random banget dah", 
       "kok sticker ini", 
       "dari mana lu dapet", 
       "sticker pilihan lu aneh", 
       "selera sticker lu beda", 
       "aneh tapi lucu",
       "lucu apaan dah", 
       "gua malah bingung", 
       "sticker tanpa konteks", 
       "konteksnya mana", 
       "ini harus diapain", 
       "sticker ini ngomong apa", 
       "gua ga ngerti bahasa sticker", 
       "gua bukan penerjemah sticker", 
       "ini kode lagi?", 
       "sticker sebagai sandi?", 
       "lu bisa ngetik kan", 
       "keyboard lu masih hidup?", 
       "ketik napa", "jangan sticker mulu", 
       "huruf masih tersedia", 
       "sticker bukan jawaban", 
       "sticker lu ga menjelaskan apa apa", 
       "reaksi gua cuma apaan", 
       "terus?", 
       "terus gua jawab apa", 
       "gua harus balas sticker?", 
       "sticker war lagi?", 
       "mau perang sticker?", 
       "stok lu ternyata banyak", 
       "combo sticker panjang bgt", 
       "streak sticker lanjut", 
       "sticker terus sampe kapan", 
       "lu ngejar rekor?", 
       "achievement sticker unlocked", 
       "rank sticker lu naik", 
       "level sticker max", 
       "skill sticker lu tinggi", 
       "jempol lu rajin", 
       "tombol sticker favorit lu", 
       "lu akrab bgt sama sticker", 
       "sticker jadi bahasa utama", 
       "chat berubah jadi sticker", 
       "ini chat apa stikeran", 
       "grup sticker resmi dibuka", 
       "sticker masuk lagi", 
       "notif masuk gua udah curiga", "ternyata sticker", "kirain ada pesan", "pesannya cuma sticker", "pesan kosong versi sticker", "komunikasi modern katanya", "lu ngobrol pake gambar kecil", "emoji kalah sama lu", "sticker lu lebih banyak omong", "sticker lagi jadi juru bicara", "juru bicara resmi hadir", "sticker sudah menyampaikan pesan", "pesannya apa gua ga tau", "maksudnya masih loading", "otak gua ngehang", "gua bingung njir", "apaan sumpah", "wkwk apaan", "bjir random", "njir lucu juga", "yaelah sticker", "udah cukup sticker lu", "jangan keluarin koleksi berikutnya", "eh muncul lagi", "lah ada lagi", "sticker berikutnya apa", "season sticker lanjut", 
